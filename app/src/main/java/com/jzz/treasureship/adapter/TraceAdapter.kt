    ...
    override fun convert(helper: BaseViewHolder, item: X) {
        ...
        if (getItemViewType(helper.adapterPosition) == TYPE_TOP) {
            ...
            helper.getView<TextView>(R.id.tvDot).background =
                context.resources.getDrawable(R.drawable.icon_trace_arrivied)
            helper.getView<TextView>(R.id.tv_content).setTextColor(context.resources.getColor(R.color.blue_light))
            helper.getView<TextView>(R.id.tvBotLine).setBackgroundColor(context.resources.getColor(R.color.blue_light))
        } else if (getItemViewType(helper.layoutPosition)  == TYPE_NORMAL) {
            helper.getView<TextView>(R.id.tvTopLine).visibility = View.INVISIBLE
            helper.getView<TextView>(R.id.tvDot).background =
                context.resources.getDrawable(R.drawable.icon_trace_normal)
            helper.getView<TextView>(R.id.tv_content).setTextColor(context.resources.getColor(R.color.Home_text_bold))
        }
