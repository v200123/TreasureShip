...
class CustomFlexlayout @JvmOverloads constructor(
    ...
    override fun onMeasure(widthMeasureSpec: Int, heightMeasureSpec: Int) {
        ...
        for (i in 0 until cCount) { // 通过索引拿到每一个子view
            ...
            // 换行 判断 当前的宽度大于 开辟新行
            if (lineWidth + childWidth > sizeWidth - paddingLeft - paddingRight) { // 对比得到最大的宽度
     ...
     * 存储所有的View
     */
    private val mAllViews: MutableList<MutableList<View>> =
        ArrayList()
    /**
     * 每一行的高度
     */
    ...
    override fun onLayout(changed: Boolean, l: Int, t: Int, r: Int, b: Int) {
        ...
        for (i in 0 until cCount) {
            ...
            // 如果需要换行
            if (childWidth + lineWidth + lp.leftMargin + lp.rightMargin > width - paddingLeft - paddingRight) { // 记录LineHeight
        ...
        for (i in 0 until lineNum) { // 当前行的所有的View
