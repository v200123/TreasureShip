...
public class AddressSelector extends LinearLayout implements View.OnClickListener{
    ...
    private class AddressAdapter extends RecyclerView.Adapter<AddressAdapter.MyViewHolder>{
        ...
        public void onBindViewHolder(MyViewHolder holder, int position) {
            ...
            if(TextUtils.equals(tabs.get(tabIndex).getText(),cities.get(position).getCityAreaName())){
            ...
            holder.tv.setText(cities.get(position).getCityAreaName());
            ...
            holder.itemView.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View v) {
                    if(onItemClickListener != null){
                        ...
                        tabs.get(tabIndex).setText(((CityInterface) v.getTag()).getCityAreaName());
