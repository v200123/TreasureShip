package com.jzz.treasureship.view.clipview;
...
import static com.jzz.treasureship.utils.FileUtil.getRealFilePathFromUri;
...
public class ClipViewLayout extends RelativeLayout {
    ...
    public Bitmap clip() {
        ...
        try {
            cropBitmap = Bitmap.createBitmap(imageView.getDrawingCache(), rect.left, rect.top, rect.width(),
                    rect.height());
